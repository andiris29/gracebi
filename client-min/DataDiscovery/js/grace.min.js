    ...
    ()
      , w = {
        ...
        slugify: function(g) {
            ...
            var f = "ąàáäâãåæăćęèéëêìíïîłńòóöôõøśșțùúüûñçżź"
...
(function() {
    ...
    a._MANIFESTS = (function() {
        ...
        ;
        var c = {};
        c[a.RECOMMEND] = d(a.RECOMMEND, "推荐图形", 0, 0, "");
        c[a.COLUMN] = d(a.COLUMN, "柱状图", 0, 1, "./assets/navigator/column.png", "");
        c[a.BAR] = d(a.BAR, "条状图", 0, 1, "./assets/navigator/bar.png", "");
        c[a.RADAR] = d(a.RADAR, "雷达图", 1, 1, "./assets/navigator/radar.png", "");
        c[a.SCATTER] = d(a.SCATTER, "散点图", 1, 1, "./assets/navigator/scatter.png", "");
        c[a.LINE] = d(a.LINE, "折线图", 1, 1, "./assets/navigator/line.png", "");
        c[a.AREA] = d(a.AREA, "面积图", 1, 1, "./assets/navigator/area.png", "");
        c[a.PIE] = d(a.PIE, "饼图", 1, 1, "./assets/navigator/pie.png", "");
        c[a.STACKED_COLUMN] = d(a.STACKED_COLUMN, "堆积柱状图", 2, 1, "./assets/navigator/stackedColumn.png", "");
        c[a.STACKED_BAR] = d(a.STACKED_BAR, "堆积条状图", 2, 1, "./assets/navigator/stackedBar.png", "");
        return c
    }
    )();
...
(function(d) {
    ...
    a._loadClass = function() {
        ...
        ;
        h(e.CARD_OPERATION, "删除");
        h(e.CALCULATE, "计算");
        h(e.SORT, "排序");
        h(e.DRILL, "每");
        h(e.GROUP, "按...分组");
        j(e.CARD_OPERATION, b.CARD_ADD_TO_DIMENSION, "\uf067 分析纬度", "");
        j(e.CARD_OPERATION, b.CARD_ADD_TO_MEASURE, "\uf067 分析指标", "");
        j(e.CARD_OPERATION, b.CARD_REMOVE, "\uf00d 移除", "");
        j(e.CALCULATE, b.CALC_COUNT, "总数", "总");
        j(e.CALCULATE, b.CALC_UNIQ_COUNT, "计数（唯一）", "数");
        j(e.CALCULATE, b.CALC_SUM, "∑ 总和", "∑");
        j(e.CALCULATE, b.CALC_AVG, "平均值", "均");
        j(e.CALCULATE, b.CALC_MAX, "最大值", "Max");
        j(e.CALCULATE, b.CALC_MIN, "最小值", "Min");
        j(e.SORT, b.SORT_NONE, "不排序", "");
        j(e.SORT, b.SORT_ASCEND, "\uf160 升序", "\uf160");
        j(e.SORT, b.SORT_DESCEND, "\uf161 降序", "\uf161");
        j(e.SORT, b.SORT_ALPHABET_ASCEND, "\uf15d 升序", "\uf15d");
        j(e.SORT, b.SORT_ALPHABET_DESCEND, "\uf15e 降序", "\uf15e");
        var g = new Date();
        j(e.DRILL, b.DRILL_YEAR, "每年 (" + g.format("yyyy") + ")", "每年");
        j(e.DRILL, b.DRILL_MONTH, "每月 (" + g.format("yyyy/M") + ")", "每月");
        var k = g.getMonsday();
        var f = new Date();
        f.setTime(k.getTime() + 7 * 24 * 3600 * 1000);
        j(e.DRILL, b.DRILL_WEEK, "每周 (" + k.format("yyyy/M/d") + " - " + f.format("M/d") + ")", "每周");
        j(e.DRILL, b.DRILL_DATE, "每日 (" + g.format("yyyy/M/d") + ")", "每日");
        j(e.GROUP, b.GROUP_MONTH, "分月 (1-12)", "月");
        j(e.GROUP, b.GROUP_DATE, "分日 (1-31)", "日");
        j(e.GROUP, b.GROUP_DAY, "分星期 (1-7)", "星");
        j(e.GROUP, b.GROUP_HOUR, "分时 (0-23)", "时")
    }
    ;
    a._loadClass();
...
(function(f) {
    ...
    var t = z.views.analysisContainer.supportClasses.ShelfBase = function(I) {
        ...
        if (q.src(this._type)) {
            this._$trashBin = f("<span/>").appendTo(H).attr("title", "移回");
        ...
        if (q.proc(this._type)) {
            ...
            if (q.des(this._type)) {
                ...
                if (q.src(this._type)) {
                    ...
                    , this);
                    S = U("addToAnalysis", 1, "分析", {
                        click: P
                    });
                    J.on("dblclick", P);
                    S = U("addToFilter", 2, "过滤", {
                        click: function(ab) {
                            P(ab, q.PROC_FILTER)
                        }
                    });
        ...
        if (h && h.numRows === 0) {
            ...
            if (this._selectedVizType === a.RECOMMEND) {
                ...
                if (k.numDimensions > 0) {
                    n = n + k.numDimensions + "个分析纬度，"
                }
                if (k.numMeasures > 0) {
                    n = n + k.numMeasures + "个分析指标。"
                }
                m.text(f.title + n);
                l.text("或者请使用推荐图形")
            }
...
(function(e) {
    ...
    d.prototype._createChildren = function() {
        ...
        this._$share.on("click", e.proxy(function() {
            alertify.reset();
            alertify.prompt("为图表输入标题：", e.proxy(function(l, m) {
                if (l) {
                    this.dispatchEvent(new j(j.SAVE,this,{
                        layout: "vizOnly",
                        title: m
...
(function(d) {
    ...
    b.prototype.rowBasedDataProvider = function(h, g, f) {
        ...
        this._subscribe(a.NOTIFICATION_ACTION_SAVE_COLLABORATION_COMPLETE, d.proxy(function(n) {
            ...
            alertify.confirm("保存成功：" + l, function(p) {
                if (!p) {
                    _.delay(function() {
...
(function() {
    ...
    b.prototype._generateButton = function(h, f) {
        ...
        if (f.link) {
            ...
            j.text(f.link.text).css("color", "#e59999");
            j.attr({
                target: "_blank",
                href: f.link.url,
                title: "右键，另存为…"
...
(function() {
            ...
            if (l.code && l.codeOverdue !== "true") {
                ...
                if (l.error) {
                    ...
                    if (l.error === "invalid_client") {
                        alertify.prompt("请留下您的店铺或联系方式：", function(n, p) {
                            if (n) {
                                var m = p;
    ...
    a.prototype._generateColumnDescriptors = function() {
        ...
        ;
        m.push(l("created", "交易创建时间", j.DATE_IN_TEXT, d.DIMENSION));
        m.push(l("status", "交易状态", j.STRING, d.DIMENSION));
        m.push(l("receiver_state", "收货人省份", j.STRING, d.DIMENSION));
        m.push(l("receiver_city", "收货人城市", j.STRING, d.DIMENSION));
        m.push(l("has_yfx", "包含运费险", j.BOOLEAN, d.DIMENSION));
        m.push(l("trade_from", "交易来源", j.STRING, d.DIMENSION));
        m.push(l("orders.title", "商品标题", j.STRING, d.DIMENSION));
        m.push(l("orders.logistics_company", "快递公司", j.STRING, d.DIMENSION));
        m.push(l("orders.total_fee", "交易金额", j.NUMBER, d.MEASURE));
        m.push(l("orders.price", "商品单价", j.NUMBER, d.MEASURE));
        m.push(l("orders.num", "商品数量", j.NUMBER, d.MEASURE));
        return m
    }
}
)();
(function() {
    ...
    g.prototype._loadOrders = function() {
        ...
        $.ajax({
            ...
            if (this._rows.length === 0) {
                var q = prompt("您还不是卖家吧？或者请您留下您的联系方式。");
    ...
    g.prototype._generateColumnDescriptors = function() {
        ...
        ;
        l.push(k("order_start_time", "下单时间", h.DATE_IN_TEXT, c.DIMENSION));
        l.push(k("order_state", "订单状态", h.STRING, c.DIMENSION));
        l.push(k("pay_type", "支付方式", h.STRING, c.DIMENSION));
        l.push(k("item_info.sku_name", "商品名称+SKU", h.STRING, c.DIMENSION));
        l.push(k("order_end_time", "结单时间", h.DATE_IN_TEXT, c.DIMENSION));
        l.push(k("consignee_info.province", "收货人省份", h.STRING, c.DIMENSION));
        l.push(k("coupon_detail.coupon_type", "优惠类型", h.STRING, c.DIMENSION));
        l.push(k("order_state_remark", "订单状态说明", h.STRING, c.DIMENSION));
        l.push(k("delivery_type", "送货（日期）类型", h.STRING, c.DIMENSION));
        l.push(k("item_info.gift_point", "赠送积分", h.STRING, c.DIMENSION));
        l.push(k("order_total_price", "总金额", h.NUMBER, c.MEASURE));
        l.push(k("order_payment", "应付金额", h.NUMBER, c.MEASURE));
        l.push(k("order_seller_price", "货款金额", h.NUMBER, c.MEASURE));
        l.push(k("seller_discount", "优惠金额", h.NUMBER, c.MEASURE));
        l.push(k("freight_price", "运费", h.NUMBER, c.MEASURE));
        l.push(k("item_info.item_total", "商品名数量", h.NUMBER, c.MEASURE));
        return l
    }
    ;
...
(function() {
    ...
    var e = r.DataSource = function(u) {
        ...
        if ($.browser.webkit) {
            ...
            E.text("下载谷歌浏览器...").addClass("grace-dataSource-chrome");
