package iris.excelas.v2007 {
	...
	import iris.excelas.v2007.supportClasses.SharedString;
	import iris.flash.utils.XMLUtil;

	[Event(name = "excelReady", type = "iris.excelas.events.ExcelEvent")]
	[Event(name = "unzipComplete", type = "iris.excelas.events.ExcelEvent")]
	/**
	...
	public class Excel extends EventDispatcher implements IExcel {
		...
		private function fzip_completeHandler(event:Event):void {
			this.dispatchEvent(new ExcelEvent(ExcelEvent.UNZIP_COMPLETE));
