:: Prepare
set folder_local=E:\andiris\CloudForge\antSoftware\andrea.graceBI\trunk\dev
...
set jar_yuicompressor=E:\andiris\Storage\坚果云\libs\js\yuicompressor-2.4.7\build\yuicompressor-2.4.7.jar
set exe_cloc="E:\andiris\Storage\坚果云\libs\common\CLOC\cloc-1.56.exe"

set skip_sync_remote=false
set skip_cloc=true
%folder_ci%\_run.bat